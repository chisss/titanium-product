...
public record PremiumCalculationRequest(
    ...
    public PremiumCalculationRequest(
            ...
            Map<String, Object> requestSnapshot,
            List<UnderwritingAdjustmentRequest> underwritingAdjustments) {
        this(calculationRequestId, bizNo, purpose, productVersion, businessTime, currency, sumInsured,
                age, gender, paymentTermYears, coverageTermYears, paymentPeriods, requestSnapshot,
                underwritingAdjustments, null, 1);
    }
}
