 ...
 */
public record CreateProductCommand(@TargetAggregateIdentifier String productId, String productCode, String productName,
                                   String productDesc, ProductEnum.ProductForm form, InsuranceType insuranceType,
                                   ProductEnum.ProductCategory category, LocalDateTime effectiveTime,
