...
public record PaymentConfig(
        List<ProductEnum.PaymentFrequency> allowedFrequencies,
        List<Integer> allowedPaymentTerms,
        ProductEnum.PeriodUnit paymentTermUnit,
        boolean autoRenewalSupported,
